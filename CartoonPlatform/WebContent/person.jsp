	...
	<div class="container-fluid" style="background: #fff;">
		...
		<div class="collapse navbar-collapse" id="my-navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#"><i class="glyphicon glyphicon-user"></i>&nbsp;&nbsp;<%=user.getUser_name()%></a></li>
							...
							function() {
								...
								if (imgPath != "") {
									...
									if (postfix != ".PNG" && postfix != ".JPG"
										...
										$(".item_msg")
												.append(
														"<div class='col-sm-12 col-xs-12 message' > <img src='img/icon.png' class='col-sm-2 col-xs-2' style='border-radius: 50%'><div class='col-sm-10 col-xs-10'><span style='font-weight: bold;''><%=user.getUser_name()%></span> <br><small class='date' style='color:#999'>刚刚</small><div class='msg_content'>"
																+ content
