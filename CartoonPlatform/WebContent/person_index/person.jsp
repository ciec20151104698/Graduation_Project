...
<head>
    ...
    <title>GPCP--最懂你的动漫交流平台ψ(*｀ー´)ψ</title>
     ...
     <div class="ace-wrapper">
                 ...
                 <div class="ace-head-container ace-container">
                     <div class="ace-head-row">
                         <div id="ace-head-col1" class="ace-head-col text-left">
                             <a id="ace-logo" class="ace-logo" href="../index.jsp">
                               <span>GP-CP</span>
                             </a>
                         </div>
                             ...
                             <div class="ace-nav-container ace-container hidden-sm hidden-xs">
                                 <nav id="ace-main-nav">
                                    <ul class="clear-list">
										...
										<li><a href="portfolio.html">资源站</a>
										<li><a href="testimonials.html">视频区</a></li>
										<li><a href="search.html">交流站</a></li>
										<li><a href="category.html">问题区</a></li>
        ...
        <article id="ace-card" class="ace-card bg-primary">
			<div class="ace-card-inner text-center">
				...
				<h1><%=login_user.getLogin_name()%></h1>
				<p class="text-muted"><%=login_user.getLogin_id()%> | <%=login_user.getLogin_type()%></p>
        ...
        <section class="section brd-btm">
            <div class="row">
                <div class="col-sm-12 clear-mrg text-box">
                    ...
                    <p><b>个性标签：Helo, I’m Ola Lowe!</b><br>
                                                                  个人简介：Logo or your Company Name, unless of course you are Microsoft or the Yellow Pages online directorye core of
		...
		<div id="ace-sidebar-inner">
			...
			<aside class="widget-area">
				...
				<section id="tag_cloud-2" class="widget widget_tag_cloud">
					...
					<div class="tagcloud">
						<a href="#tag/audios/" class="tag-link-5 tag-link-position-1" title="1 topic" style="font-size: 1em;">Audios</a>
