...
<body>
	...
	<div id="xt-top">
		...
		<div class="xt-geren">
			<div class="xt-exit">
				<span class="xt-span">您好!欢迎<span class="xt-yanse"><%=userinfo.getLogin_name() %></span>登录管理中心
				...
				<table cellpadding="0" cellspacing="0" border="0" bgcolor="#dcdcdc"
					...
					<%
						...
						for (ArticleBean tl : list) {
							String article_title = tl.getCommunication_title();
							int article_id = tl.getCommunication_id();
					%>
